...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
     * | bright+| ctrl-a |        | CTRL-F |        |        | P4     | RESET  | P6     | +      |        |        |        |        |  END   |
     * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
    ...
    [_FN] = LAYOUT_ortho_5x15( /* FUNCTION */
        ...
        _______, _______, _______, LCTL(KC_T), _______, RGB_HUI, KC_P7,   KC_P8,   KC_P9,   KC_LBRC, KC_RBRC, _______, KC_UNDS, _______, KC_HOME,
        RGB_VAI, LCTL(KC_A), _______, _______, LCTL(KC_F), _______, KC_P4,   RESET,   KC_P6,   KC_PLUS, _______, _______,   _______, _______, KC_END,
        RGB_VAD, LCTL(KC_Z), _______, LCTL(KC_C),  LCTL(KC_V), _______, KC_P1,   KC_P2,   KC_P3,   KC_PENT, _______, _______, _______, _______, KC_ENT,
