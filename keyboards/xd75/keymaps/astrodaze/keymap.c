...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QW] = LAYOUT_ortho_5x15( /* QWERTY */
        ...
        KC_LSPO, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_P4,  KC_P5,  KC_P6,  KC_H, SFT_J, GUI_K, ALT_L, CTL_SCLN,  KC_QUOT,
        KC_LCPO, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_P1,  KC_P2,   KC_P3, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_SFTENT,
        KC_LCTL, KC_RCTL, KC_RALT, KC_LGUI, LT(_FN,KC_BSPC), KC_SPC,  KC_LEFT, KC_P0, KC_RGHT, KC_SPC,  LT(_FN,KC_ENT),  KC_LEFT, KC_DOWN, KC_UP, KC_RGHT
    ),
