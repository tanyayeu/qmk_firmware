...
qk_tap_dance_action_t tap_dance_actions[] = {
  [TD_SFT_PRN] = ACTION_TAP_DANCE_DOUBLE(KC_LSPO, KC_RPRN) //HOLD FOR LSFT, TAP FOR LPRN, DT FOR RPRN
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_reviung39(
    ...
    TD_SFT_PRN,  KC_A,     KC_S,     KC_D,     KC_F,      KC_G,               KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,
  ...
  [_RAISE] = LAYOUT_reviung39(
    ...
    _______,  KC_MINS,  KC_EQL,   KC_LBRC,  KC_RBRC,   KC_BSLS,            KC_LEFT,    KC_LEFT,    KC_UP,    KC_RGHT,    KC_F5,    KC_F6,
