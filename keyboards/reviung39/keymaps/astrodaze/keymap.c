...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_reviung39(
    ...
    KC_CAPS,  KC_UNDS,  KC_PLUS,  KC_LBRC,  KC_QUES,   KC_PIPE,            KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  KC_GRV,   KC_BSLS,
    _______,  _______,   KC_LGUI,  KC_LALT,  _______,   _______,            KC_HOME,  KC_END,   KC_PGUP,  KC_PGDN,  KC_PSCR,  RSFT_T(KC_SPC),
