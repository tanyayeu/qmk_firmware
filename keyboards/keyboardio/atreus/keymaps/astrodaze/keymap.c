...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QW] = LAYOUT( /* Qwerty */
    ...
    KC_A,    KC_S,    KC_D, SFT_F,    KC_G,                                        KC_H,    SFT_J,   GUI_K,   ALT_L,   CTL_SCLN,
    LT(_OTHER, KC_Z),    KC_X,    KC_C,    KC_V,    KC_B,    KC_GRV,                        KC_BSLS, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,
    KC_ESC, KC_RALT, KC_LGUI,  LT(_FUN,KC_BSPC), LT(_NUM,KC_BSPC),  LT(_FUN,KC_TAB),     LT(_SYMBOL,KC_ENT), LT(_SYMBOL,KC_SPC),  LT(_FUN,KC_ENT), MO(_OTHER), KC_DEL, KC_ENT ),

  [_NUM] = LAYOUT( 
    KC_1, KC_2,   KC_3,   KC_4,  KC_5,                            KC_6, KC_7,    KC_8,   KC_9, KC_0,
    KC_CAPS, _______, KC_TILD, KC_QUES, KC_GRV,                  KC_LEFT, KC_DOWN,  KC_UP, KC_RGHT, KC_QUOT,
  ...
  [_FUN] = LAYOUT( 
    ...
    KC_CAPS,  _______, _______, KC_QUES, _______,                   _______, _______,   _______,   KC_MINS,   KC_DQUO  ,
    _______,   _______, _______,   _______,   _______,          _______, _______, _______,   _______,   _______,   _______,   _______  ,
    _______,  _______, _______, _______, _______, _______,      _______, _______,  KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY ),

  [_SYMBOL] = LAYOUT( 
    KC_EXLM,  KC_AT, KC_HASH,   KC_DLR,  KC_PERC,                                     KC_CIRC,   KC_AMPR,   KC_ASTR,   KC_UNDS,   KC_PLUS ,
    KC_LPRN,  KC_RPRN, KC_LCBR, KC_RCBR, _______,                          _______, _______,   _______,   KC_BSLS,   KC_PIPE  ,
    ...
    [_OTHER] = LAYOUT( 
    KC_F1,  KC_F2, KC_F3,   KC_F4,  KC_F5,                                     KC_LBRC,   KC_RBRC,   _______,   KC_UNDS,   KC_PIPE ,
    KC_F6,  KC_F7, KC_F8, KC_F9, KC_F10,                                       _______, _______,   _______,   KC_MINS,   KC_BSLS  ,
    _______,   _______, _______,   _______,   _______,   _______,              _______, _______,   _______,   _______,   _______,   _______  ,
    _______,     _______, _______, _______, _______, _______,                 _______, _______,  _______, _______, _______, _______ )
};  
