...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT_base_kit_all(
    ...
    KC_PGUP, KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    SFT_J,   GUI_K,   ALT_L,   CTL_SCLN, KC_QUOTE, KC_ENT,
    KC_PGDN, KC_LSFT, KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  OTHER,
    KC_END,  KC_LCTL,  KC_LGUI, KC_TAB,      LT(_LOWER, KC_BSPC),      LT(_RAISE,KC_SPACE),   KC_CAPS, RAISE,   KC_RGUI,  LOWER
  ),
  ...
  [_LOWER] = LAYOUT_base_kit_all(
    KC_GRAVE,  KC_TILD,  KC_1,      KC_2,      KC_3,      KC_4,      KC_5,      KC_6,      KC_7,      KC_8,      KC_9,     KC_0,       KC_UNDS,    _______,
    KC_TILD,   KC_CAPS,  KC_EXLM,   KC_AT,     KC_HASH,   KC_DLR,    KC_PERC,   KC_CIRC,   KC_AMPR,   KC_ASTR,   M_PAR,    M_BKT,      _______,    TD(TD_DBQT),
